...
layout: post
post-image: /assets/images/ldap.png
...
<div style="text-align: center"><img src="/assets/images/ldap1.png" width="1000" /></div>
<br>
...
<div style="text-align: center"><img src="/assets/images/ldap2.png" width="300" /></div>
...
siguientes opciones para nuestro uso personal:
	...
	* **Base DN**
	...
	<div style="text-align: center"><img src="/assets/images/ldap3.png" width="600" /></div>
...
<div style="text-align: center"><img src="/assets/images/ldap4.png" width="500" /></div>
...
importante para configurar LDAP. En ella, nos encontramos las siguientes opciones: 
	...
	<div style="text-align: center"><img src="/assets/images/ldap5.png" width="500" /></div>
...
Rocket.Chat. Esta sección dispone de las siguientes opciones:
	...
	* **Campo Identificador Único**
	...
	<div style="text-align: center"><img src="/assets/images/ldap6.png" width="500" /></div>
	...
	* **Dominio Predeterminado**
	...
	<div style="text-align: center"><img src="/assets/images/ldap7.png" width="500" /></div>
	...
	* **Mapa de Campos de Datos de Usuario**
	...
	<div style="text-align: center"><img src="/assets/images/ldap8.png" width="600" /></div>
	...
	* **Filtro de grupo de usuarios**
	...
	<div style="text-align: center"><img src="/assets/images/ldap9.png" width="600" /></div>
	...
	* **Mapa de grupo de datos de usuario**
	...
	<div style="text-align: center"><img src="/assets/images/ldap10.png" width="600" /></div>
	...
	* **Channel Administrator**
	...
	<div style="text-align: center"><img src="/assets/images/ldap11.png" width="500" /></div>
...
<div style="text-align: center"><img src="/assets/images/ldap12.png" width="300" /></div> 
...
<div style="text-align: center"><img src="/assets/images/ldap13.png" width="1000" /></div>
<br>
